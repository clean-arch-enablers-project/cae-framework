# ☕ cae-framework
DISCLAIMER: this README is not up to date as we haven't reached the version 1.0.0 and new features are constantly getting built. 

Even that being the case, what's written in this README still is a good guide for getting started, it is just that not all features are described here. That being said:
