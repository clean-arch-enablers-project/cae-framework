...
public class Autolog<U extends UseCase> {
    ...
    private <I extends UseCaseInput> void handleInputLogging(I input) {
        this.stringBuilder.append(IOAutologHandler.generateTextForLoggingInput(input, "USE CASE"));
    }

    private <O> void handleOutputLogging(O output) {
        this.stringBuilder.append(IOAutologHandler.generateTextForLoggingOutput(output, "USE CASE"));
    }
