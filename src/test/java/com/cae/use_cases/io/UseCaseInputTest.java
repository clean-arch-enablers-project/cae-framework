...
class UseCaseInputTest {
    ...
    void shouldNotThrowWhenInputObjectIsAlright(){
        Assertions.assertDoesNotThrow(() -> this.input.autoverify(this.context));
    }
    ...
    void shouldThrowBlankFieldExceptionWhenANotBlankInputFieldFieldIsLeftBlank(){
        ...
        Assertions.assertThrows(BlankFieldException.class, () -> this.input.autoverify(this.context));
    }
    ...
    void shouldThrowEmptyFieldExceptionWhenANotEmptyInputFieldFieldIsLeftEmpty(){
        ...
        Assertions.assertThrows(EmptyFieldException.class, () -> this.input.autoverify(this.context));
    }
    ...
    void shouldThrowNotBlankAnnotationOnWrongTypeExceptionWhenUsedOnAWrongType(){
        ...
        Assertions.assertThrows(NotBlankAnnotationOnWrongTypeException.class, () -> anotherInput.autoverify(this.context));
    }
    ...
    void shouldThrowNotEmptyAnnotationOnWrongTypeExceptionWhenUsedOnAWrongType(){
        ...
        Assertions.assertThrows(NotEmptyAnnotationOnWrongTypeException.class, () -> anotherInput.autoverify(this.context));
    }
    ...
    void shouldThrowNullFieldExceptionWhenANotNullInputFieldFieldIsLeftNull(){
        ...
        Assertions.assertThrows(NullFieldException.class, () -> this.input.autoverify(this.context));
    }
    ...
    void shouldThrowValidInnerPropertiesAnnotationOnWrongTypeExceptionWhenUsedOnAWrongType(){
        ...
        anotherInput.setSomeNumber(10);
        Assertions.assertThrows(ValidInnerPropertiesAnnotationOnWrongTypeException.class, () -> anotherInput.autoverify(this.context));
    }
    ...
    void shouldThrowValidInnerPropertiesAnnotationOnWrongTypeExceptionWhenUsedOnAListOfNonUseCaseItems(){
        ...
        Assertions.assertThrows(ValidInnerPropertiesAnnotationOnWrongTypeException.class, () -> someInput.autoverify(this.context));
    }
    ...
    void shouldThrowGetterMethodNotFoundExceptionWhenTheInputHasNoAccessibleGettersForItsProperties(){
        ...
        Assertions.assertThrows(UseCaseInput.GetterMethodNotFoundException.class, () -> someInput.autoverify(this.context));
    }
    ...
    void whenGetterOfFieldThrowsShouldBeAbleToMapTheExceptionToInternalMappedException(){
        ...
        Assertions.assertThrows(InternalMappedException.class, () -> someInput.autoverify(this.context));
    }
